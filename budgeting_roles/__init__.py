...
class Player(BasePlayer):
    ...
    manip_check_role = models.StringField(
        label="<b>Which role were you assigned</b> at the beginning of the study?",
        choices=[
    ...
    # ===== Advisor Competence Mediators =====
    competence_knowledgeable = models.IntegerField(
        label="The advisor seemed knowledgeable.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )
    competence_capable = models.IntegerField(
        label="The advisor seemed capable.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )
    competence_skilled = models.IntegerField(
        label="The advisor seemed skilled.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )

    # ===== Advisor Warmth Mediators =====
    warmth_friendly = models.IntegerField(
        label="The advisor seemed friendly.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )
    warmth_trustworthy = models.IntegerField(
        label="The advisor seemed trustworthy.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )
    warmth_sincere = models.IntegerField(
        label="The advisor seemed sincere.",
        choices=[[1, '1 - Strongly disagree'], [2, '2'], [3, '3'], [4, '4 - Neutral'], [5, '5'], [6, '6'], [7, '7 - Strongly agree']],
        widget=widgets.RadioSelectHorizontal
    )
...
class RoleAssignment(Page):
    ...
    def vars_for_template(player: Player):
        ...
        role_descriptions = {
            'finance_director': """
                <p>As a <strong>Finance Director</strong>, you:.</p>
                <ul>
                    <li>are responsible for the financial management of your municipality;</li>
                    <li>shall conduct a preliminary examination of the financial planning, the draft budget and its supplements;</li>
                    <li>exercise supervisory control over the entire financial budget.</li>
                </ul>
            """,
            'politician': """
...
class Mediators(Page):
    ...
    form_model = 'player'
    form_fields = [
        'impartiality_unbiased', 'impartiality_objective', 'impartiality_fair',
        'competence_knowledgeable', 'competence_capable', 'competence_skilled',
        'warmth_friendly', 'warmth_trustworthy', 'warmth_sincere',
        'attention_check'
    ]
    ...
    def error_message(player: Player, values):
        ...
        if values.get('competence_knowledgeable') is None:
            return 'Please rate whether the advisor seemed knowledgeable.'
        if values.get('competence_capable') is None:
            return 'Please rate whether the advisor seemed capable.'
        if values.get('competence_skilled') is None:
            return 'Please rate whether the advisor seemed skilled.'
        if values.get('warmth_friendly') is None:
            return 'Please rate whether the advisor seemed friendly.'
        if values.get('warmth_trustworthy') is None:
            return 'Please rate whether the advisor seemed trustworthy.'
        if values.get('warmth_sincere') is None:
            return 'Please rate whether the advisor seemed sincere.'
